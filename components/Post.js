  ...
  return (
    <div className='bg-white my-7 border rounded-lg'>
       ...
       <div className='flex items-center p-5'>
        <img src={userImg} className="rounded-full h-12 w-12 object-contain border p-1 mx-3" alt='' />
       ...
       {comments.length > 0 && (
        <div className='ml-10 h-20 overflow-y-scroll scrollbar-thumb-slate-200 scrollbar-thin'>
          {comments.map(comment => (
            <div key={comment.id} className="flex items-center space-x-2 mb-3">
              <img className='h-6 rounded-full' src={comment.data().userImg} alt='' />
       ...
       placeholder='Add a comment' onChange={e => setComment(e.target.value)} 
       value={comment}/>
